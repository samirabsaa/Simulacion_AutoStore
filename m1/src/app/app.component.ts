...
export class AppComponent implements OnInit, OnDestroy {
  ...
  readonly nav: NavItem[] = [
    { key: 'panel',    path: '/panel',    icon: '📊', label: 'Panel de Estados'              },
    { key: 'monitor',  path: '/monitor',  icon: '⊞',  label: 'Monitor Simulación (2D/3D)'   },
    { key: 'reportes', path: '/reportes', icon: '🗄',  label: 'Datos Estadísticos'          },
